...
|Bicep|[GitHub](https://github.com/Azure/bicep)|[Learn](https://learn.microsoft.com/en-us/azure/azure-resource-manager/bicep/install)|[Document](https://learn.microsoft.com/en-us/azure/azure-resource-manager/bicep/)|Bicep is a language for declaratively deploying Azure resources. You can use Bicep instead of JSON for developing your Azure Resource Manager templates (ARM templates).|
...
|App Center CLI|[GitHub](https://github.com/microsoft/appcenter-cli)|`npm install --location=global appcenter-cli`|[Document](https://learn.microsoft.com/en-us/appcenter/cli/)|App Center command-line interface is a unified tool for running App Center services from the command-line.|
|Azure AI CLI|[Learn](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/cli-install?tabs=windows%2Cterminal)|[Learn](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/cli-install?tabs=windows%2Cterminal)|[Learn](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/cli-install?tabs=windows%2Cterminal)|The Azure AI command-line interface (CLI) is a cross-platform command-line tool to connect to Azure AI services and execute control-plane and data-plane operations without having to write any code.|
|Azure Functions Core Tools|[GitHub](https://github.com/Azure/azure-functions-core-tools)|[Download](https://learn.microsoft.com/en-us/azure/azure-functions/functions-run-local?tabs=windows%2Cisolated-process%2Cnode-v4%2Cpython-v2%2Chttp-trigger%2Ccontainer-apps&pivots=programming-language-csharp#install-the-azure-functions-core-tools)|[Document](https://learn.microsoft.com/en-us/azure/azure-functions/functions-run-local)|Azure Functions Core Tools lets you develop and test your functions on your local computer.|
...
|Dev Proxy|[Learn](https://learn.microsoft.com/en-us/microsoft-cloud/dev/dev-proxy/overview)|[Download](https://aka.ms/devproxy/download)|[Document](https://aka.ms/devproxy/docs)|Dev Proxy is a command line tool for simulating APIs for testing apps.|
